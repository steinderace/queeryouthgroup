    ...
    return (
        <nav className="bg-[#F5EFE0] h-20 border-gray-200 flex items-center">
            <div className="max-w-screen-xl flex w-full items-center justify-between mx-auto px-4"> {/* Use w-full */}
                ...
                className="md:hidden inline-flex items-center justify-center p-2 w-10 h-10 text-white rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200"
                >
                ...
                {/* Navbar links */}
                <div className="hidden md:flex items-center"> {/* Ensure `items-center` here */}
